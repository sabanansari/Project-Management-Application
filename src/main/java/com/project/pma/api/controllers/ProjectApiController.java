package com.project.pma.api.controllers;
...
public class ProjectApiController {
	...
	public Project partialUpdate(@PathVariable("id") long id, @RequestBody Project patchProject) {
		Project project = proRepo.findById(id);
	...
	@ResponseStatus(HttpStatus.OK)
	public Iterable<Project> findPaginatedProjects(@RequestParam("param") int page, @RequestParam("size") int size){
